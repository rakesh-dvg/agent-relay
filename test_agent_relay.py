...
_test_db = Path(tempfile.gettempdir()) / "agent-relay-test.db"
os.environ.setdefault("RELAY_DATABASE_URL", f"sqlite:///{_test_db.as_posix()}")
...
def empty_database():
    ...
    # scratch temp file above; never run against a DB with data you need.
